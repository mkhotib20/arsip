<?php include 'header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <?php echo form_open('setting/saveUk') ?>
                <div class="row">
                  <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td></td>
                      <td><?php echo $vd['mitra_nama'] ?></td>
                      <td hidden="" ><?php echo $vd['mitra_id'] ?></td>
      ...
      .then((willDelete) => {
        ...
        if (willDelete) {
          $.ajax({
              ...
              dataType : "JSON",
              data : {id:id, name:'mitra_id', tbl:'tb_mitra'},
